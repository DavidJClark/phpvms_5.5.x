...
<ul>
	...
	<li><a href="http://www.phpvms.net">phpVMS Homepage</a>
	<li><a href="http://www.phpvms.net/docs">phpVMS Documentation</a></li>
	<li><a href="http://www.phpvms.net/forum">phpVMS Forum and Support</a></li>
	<li><a href="http://www.nsslive.net/codon">Codon Framework</a></li>
</ul>

<p>I'd also like to thank everyone who has helped in the planning and testing of this software; without you guys this would have been a big fail!</p>

<p>Icons from <a href="http://www.interfacelift.com" target="_new">InterfaceLift</a> and <a href="http://www.fasticon.com" target="_new">FastIcon.com</a>. </p>

<p>phpVMS is licensed on the Creative Commons Attribution-Noncommercial-Share Alike 3.0 Unported License. By using and installing this software, you agree to the terms of this license. The details about the license can be viewed <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/" target="_new">here</a>, or the complete license text below.</p>

<h3>License</h3>
<div style="overflow: auto; height: 400px; border: 1px solid #666; margin-bottom: 20px; padding: 5px; padding-top: 0px; padding-bottom: 20px;">
